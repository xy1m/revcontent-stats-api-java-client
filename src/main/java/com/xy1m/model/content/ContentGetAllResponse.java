...
public class ContentGetAllResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContentGetAllResponse)) return false;
        ContentGetAllResponse that = (ContentGetAllResponse) o;
        return Objects.equals(getBoostId(), that.getBoostId()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getBoostId(), getContentId(), getHeadline(), getTargetUrl(), getImageUrl(), getBrandName(), getAdminStatus(), getCreativeDenialReason(), getEnabled(), getContentType(), getUtmCodes(), getAvgPosition(), getImpressions(), getClicks(), getConversions(), getCtr(), getAvgCpc(), getCost(), getValueReturn(), getProfit());
    }
