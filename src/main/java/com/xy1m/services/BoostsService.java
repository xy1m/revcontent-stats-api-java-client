...
public interface BoostsService {
    ResultsData<BoostGetAllResponse> getAll(Authentication auth) throws APIUnauthorizedException,
            APIServerException, APIClientException;

    ResultCampaign<BoostAddResponse> createCpc(Authentication auth, BoostAddRequest payload) throws APIUnauthorizedException,
            APIServerException, APIClientException;

    ResultCampaign<BoostAddResponse> createCpa(Authentication auth, BoostAddRequest payload) throws APIUnauthorizedException,
            APIServerException, APIClientException;
