...
public interface ContentsService {
    ResultCreative<ContentAddOrUpdateResponse> add(Authentication auth, Long boostId, ContentAddRequest payload)
            throws APIUnauthorizedException, APIServerException, APIClientException;

    ResultsData<ContentAddOrUpdateResponse> update(Authentication auth, Long boostId, ContentUpdateRequest payload)
            throws APIUnauthorizedException, APIServerException, APIClientException;

    ResultsData<ContentGetAllResponse> getAll(Authentication auth)
            throws APIUnauthorizedException, APIServerException, APIClientException;

    ResultsData<ContentGetResponse> getByBoostId(Authentication auth, Long boostId)
            throws APIUnauthorizedException, APIServerException, APIClientException;
}
